...
public class AppThwackTest extends TestCase {
    ...
    public void testGetResults() {
    	...
    	assertEquals(36, result.summary.failures.intValue());
    	assertEquals(0, result.summary.errors.intValue());
    	assertEquals(64, result.summary.passes.intValue());
    	assertEquals(0, result.summary.warnings.intValue());
    	assertEquals(100, result.summary.count.intValue());
    	assertEquals(100, result.summary.completed.intValue());
